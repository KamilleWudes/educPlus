                ...
                <div class="card border-top border-0 border-4 border-white">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-white">Nouvel Etudiant</h5>
                        </div>
                        <hr>
                        <form class="row g-3" method="POST"
                            action="{{ route('createEtudiant') }}"enctype='multipart/form-data'>
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group"> <span class="input-group-text"><i
                                    ...
                                    <input type="text"
                                        ...
                                        id="inputPhoneNo" name="telephone1" placeholder="Phone No" />
                                </div>
                                @error('telephone1')
                                    <span class="error" style="color:red">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" name="adresse" id="inputAddress3" placeholder="Enter Address" rows="2"></textarea>
                                @error('adresse')
                                    <span class="error" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
