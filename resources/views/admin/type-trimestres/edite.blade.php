    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-9 mx-auto">
                <br> <br>
                <h6 class="mb-0 text-uppercase">Edition Type trimestre</h6>
                <hr />
                <div class="card">
                    <form class="row g-3" method="POST" action="{{ url('update_Typetrimestres/'. $TypeTrimestres->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="border p-3 rounded">
                                ...
                                <input class="form-control @error('nom') is-invalid  @enderror mb-3" type="text" value="{{$TypeTrimestres->nom}}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="{{ route('trimestre') }}"> <button type="button" class="btn btn-danger px-5"
