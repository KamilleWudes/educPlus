                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                        <h4>{{ $professeurs->nom }} {{ $professeurs->prenom }}</h4>
                                        {{--  <p class="mb-1">Full Stack Developer</p>  --}}
                                        <p class="font-size-sm">{{ $professeurs->email }}</p>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" value="{{ $professeurs->nom }} {{ $professeurs->prenom }}" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" class="form-control" placeholder="Homme" />
                                            @else
                                            <input type="text" class="form-control" placeholder="Femme" />
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" value="{{ $professeurs->telephone1 }}" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" value="{{ $professeurs->email }}" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" value="{{ $professeurs->adresse }}" />
                                        </div>
                                    </div>
                                    <div class="row">
