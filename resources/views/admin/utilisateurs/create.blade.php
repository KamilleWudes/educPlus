                ...
                <div class="card border-top border-0 border-4 border-white">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-white">Nouvel Responsable</h5>
                        </div>
                        <hr>
                        <form class="row g-3" method="POST"
                            ...
                            {{--  <div class="col-md-6">
                                ...
                                <div class="input-group"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                                    <select class="form-select mb-0 @error('role_id') is-invalid  @enderror" name="role_id"  value="{{ old('role_id') }}"
                                        aria-label="Default select example">
