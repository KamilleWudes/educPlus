                    ...
                    <div class="table-responsive">
                        <div class="ms-auto"><a href="{{ route('addutilisateur') }}" class="btn btn-light radius-30 mt-2 mt-lg-0"
                            data-bs-toggle="" data-bs-target=""><i
                                class="bx bxs-plus-square"></i>Nouvel Responsable</a></div>
                    </div><br>
                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td style="text-align:center">{{ optional($user->ecoles)->nom }}
                                        ...
                                        <td style="text-align:center"><a href="{{ url('detail=' . $user->id) }}"><button type="button"
                                            class="btn btn-light btn-sm radius-30 px-4"> Voir Détail</button></a></td>

                                        <td>

                                            <div class="d-flex order-actions">
                                                <a href="{{ url('utilisateur=' . $user->id) }}" class=""><i
