        ...
        $(document).ready(function() {
            ...
            $('#anneeScolaire, #type-trimestre, #classe').on("change", function() {
                ...
                $.ajax({
                    ...
                    success: (response) => {
                        console.log("typeTrimestreChoisie", response.typeTrimestreChoisie)
                        ...
                        for (var i = 0; i < response.classesEtudiants.length; i++) {
                            classe += '<option  value=""></option>';

                            classe += '<option  value="' + response.classesEtudiants[i].id +
                                '">' +
                                response.classesEtudiants[i].nom + '</option>';
                        }
